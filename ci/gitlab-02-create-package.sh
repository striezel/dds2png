...
wget -O dds2png_${VERSION}.orig.tar.bz2 https https://gitlab.com/striezel/dds2png/-/archive/${TAG}/dds2png-${TAG}.tar.bz2
tar -x --bzip2 -f dds2png_${VERSION}.orig.tar.bz2
if [[ $? -ne 0 ]]
then
...
mv dds2png-${TAG} dds2png-${VERSION}
if [[ $? -ne 0 ]]
then
...
mv dds2png*.deb dds2png_${VERSION}-${RELEASE}_${ARCH}.deb
